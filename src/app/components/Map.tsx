    ...
    <section className="bg-gray-50 py-16 border-t border-gray-200">
      <div className="max-w-[1600px] mx-auto px-6 md:px-12 lg:px-16">
        <motion.div
          ...
          className="bg-white rounded-md p-6 md:p-10 shadow-sm border border-gray-200"
        >
          <div className="flex flex-col md:flex-row gap-10 items-center mb-8">
            <div className="flex-1 text-center md:text-left">
              <div className="inline-flex items-center justify-center p-3 bg-[#dc2626]/10 text-[#dc2626] rounded-md mb-6">
                <MapPin className="w-8 h-8" />
              </div>
              <h2 className="text-3xl md:text-5xl font-bold text-[#0a1628] mb-4 font-['Plus_Jakarta_Sans'] uppercase">
            ...
            <div className="w-full md:w-auto flex-shrink-0">
              <div className="bg-gray-50 rounded-md p-6 border border-gray-200 text-center md:text-left">
                <p className="font-bold text-[#0a1628] text-lg mb-2 uppercase font-['Plus_Jakarta_Sans']">Physical Address</p>
          ...
          <div className="w-full h-[400px] md:h-[500px] bg-gray-100 rounded-md overflow-hidden relative border border-gray-200">
            <iframe
